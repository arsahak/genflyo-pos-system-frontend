...
export default function AddNewProduct() {
  ...
  const [formData, setFormData] = useState({
    ...
    // Inventory & Batch
    openingStockBoxes: "0", // Input in Boxes
    stock: "0", // Calculated in Strips
    minStock: "10",
    batchNumber: "",
    expiryDate: "",
    manufacturingDate: "",
    expiryAlertDays: "90", // Notify 3 months before
            ...
            <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
              ...
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  >
                    Create a new inventory item with unit conversion and
                    details.
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
              ...
              >
                {loading ? (
                  ...
                  <>
                    <MdSave size={18} /> <span>Save Product</span>
                  </>
                )}
              </button>
            </div>
